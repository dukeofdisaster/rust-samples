...
mod tests {
    ...
    fn positive_results() {
        ...
        // bolean ops with results. look at what's returned
    ...
    fn negative_results() {
        ...
        // other than positive results, negative results often have their own
        // functions such as map_err. Other than that, the boolean functions
        // behave consistently and treat the Err result as false.
